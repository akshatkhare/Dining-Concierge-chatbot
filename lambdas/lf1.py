...
def validate_book_restaurant(slots):
    ...
    num_people = try_ex(lambda: slots['Number'])
...
def book_restaurant(intent_request):
    ...
    num_people = try_ex(lambda: intent_request['currentIntent']['slots']['Number'])
...
def restaurantSQSRequest(requestData):
    ...
    queue_url = 'https://sqs.us-east-1.amazonaws.com/106689315603/standard_queue'
    delaySeconds = 5
    messageAttributes = {
       'Location': {
            'DataType': 'String',
